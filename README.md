...
"Петиметр" в НКРЯ представлен в использовании почти исключительно в восемнадцатом веке, тогда как гугл н-граммы показывают его столь же часто употребимым в 1950-е. Снова разница в данных двух корпусов, которую сложно проанализировать сходу, без информации о текстах, которые в них лежат. "Щёголь" как его не слишком употребимый, но всё же достаточно современный аналог хоть появляется в корпусе в одно время с "петиметром", но используется в десять раз чаще.
